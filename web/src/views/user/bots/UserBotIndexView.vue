        ...
        <div class="card-body">
          <table class="table table-striped table-hover">
            ...
            <tr v-for="bot in bots" :key="bot.id">
              ...
              <td>
                <button type="button" class="btn btn-secondary" style="margin-right: 10px" data-bs-toggle="modal" :data-bs-target="'#update-bot-button-'+bot.id">修改</button>
                  ...
                  <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" @click="bot_update(bot)">保存修改</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  setup() {
    ...
    const bot_add = () => {
      ...
      $.ajax({
        url: "https://snakechess.ymswdfg.top/api/user/bot/add/",
        type: 'post',
        data: {
          title: botadd.title,
    ...
    const remove_bot = (bot) => {
      $.ajax({
        url: "https://snakechess.ymswdfg.top/api/user/bot/remove/",
        type: 'post',
        data: {
          bot_id: bot.id,
        },
    ...
    const bot_update = (bot) => {
      botadd.error_message = "";
      $.ajax({
        url: "https://snakechess.ymswdfg.top/api/user/bot/update/",
        type: 'post',
        data: {
          bot_id:bot.id,
          title: bot.title,
